...
private[spark] trait RpcEndpoint {
  ...
  /**
    ...
    */
  /**
    * 在 RpcEndpoint 开始处理消息之前调用，可以在RpcEndpoint正式工作之前做一些工作。
    */
  def onStart(): Unit = {
    // By default, do nothing.
  }
  ...
  /**
    ...
    */
  /**
    * 在停止 RpcEndpoint时调用，可以在RpcEndpoint停止的时候做一些收尾的工作。
    */
  def onStop(): Unit = {
    // By default, do nothing.
  }
...
/**
  ...
  */
/**
  * 主要是用于对消息的处理，必须是线程安全的场景。其对消息的处理都是串行的，即前一条信息处理完才能接着处理下一条消息。
  */
